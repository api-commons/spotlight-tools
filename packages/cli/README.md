...
This build sends no analytics. The upstream Spectral packages added
[Scarf](https://scarf.sh/) install-time telemetry on 2026-06-30; it has been removed here from
`cli`, `core`, `rulesets`, `formats`, `functions`, and the Docker image. Nothing phones home on
install or on lint.
